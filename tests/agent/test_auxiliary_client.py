...
class TestResolveAutoCustomProvider:
    """Regression test for #10314: _resolve_auto must read config.yaml
    base_url/api_key when the live main_runtime dict doesn't carry them, so
    that auto-routing for a custom provider doesn't silently fall through to
    the OpenRouter aggregator chain."""
